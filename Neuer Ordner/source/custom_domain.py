...
build_subdirectories = recursive_glob.recursive_glob(
    build_directory, lib_file_patterns
    )
...
from numpydoc.numpydoc import mangle_docstrings # noqa
from docutils.statemachine import ViewList # noqa
from sphinx.domains.python import PythonDomain # noqa
from scipy._lib._util import getfullargspec_no_self # noqa
...
def wrap_mangling_directive(base_directive, directive_type):
    ...
    class directive(base_directive):
        def run(self):
            ...
            mangle_docstrings(
                env.app, "function", impl_name, None, None, lines
            )
